<div id="user-contents" class="contents">	
	...
	<form action="add_user_rate" method="post">
	<div id="user-inside" class="lefted">
			...
			if($checker!='empty'):
				foreach ($metric as $metric_item): 
				 ...
				 endforeach; 
					...
					$id = $metric_item['field_id'];
					echo "<tr><td>".$metric_item['field_name']."<td><td><input type='text' name='metric_item[]'></input></td></tr>";	
		...
		<?php
			if($checker!='empty'): 
				echo "<button class='righted'>Next</button>";

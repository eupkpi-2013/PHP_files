<div id="user-contents" class="contents">
  <div id="user-kpimenu" class="accordion lefted">
		<?php foreach ($iscu as $iscu_item): 
			$url = $iscu_item['iscu'];
			echo "<div><h3><a href='superuser_assign?iscu=".$url."'>".$iscu_item['iscu']."</a></h3><ul>";
			echo "</ul></div>";
		endforeach; 
		?>
	</div>	
	<div id="user-inside" class="inside">
		...
		foreach ($kpi as $kpi_item): 
			 echo "<div id='user-inside' class='inside'><ul class='indented-list'><input class='checklist' type='checkbox' name='kpi[]' value=\"".$kpi_item['kpi_id']."\">KPI: &nbsp".$kpi_item['kpi_name']."</input>";
